...
function configure(mochaOpts: Mocha.MochaOptions): void {
...
class CoverageRunner {
	...
	public setupCoverage(): void {
		...
		let fileMap: Dictionary<boolean> = {};
		srcFiles.forEach((file: string) => {
			let fullPath: string = paths.join(sourceRoot, file);
